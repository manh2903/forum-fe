...
export default function Navbar() {
  ...
  return (
    <AppBar
      ...
      elevation={0}
      sx={{
        background: trigger ? 'rgba(255,255,255,0.95)' : 'rgba(255,255,255,0.8)',
        backdropFilter: 'blur(12px)',
        borderBottom: '1px solid',
        borderColor: trigger ? '#e2e8f0' : 'transparent',
            ...
            {[
              ...
              <Button
                ...
                sx={{
                  ...
                  backgroundColor: location.pathname === nav.path ? alpha('#6366f1', 0.1) : 'transparent',
                  '&:hover': { color: 'text.primary', backgroundColor: alpha('#6366f1', 0.08) },
                  borderRadius: '8px',
                  px: 1.5,
                }}
              >
            ...
            {user ? (
              <>
                ...
                <Tooltip title="Thông báo">
                  <IconButton component={Link} to="/notifications" size="small" sx={{ color: 'text.secondary' }}>
